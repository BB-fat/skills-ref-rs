...
Defines requirements for making the skills-ref-rs tool installable via standard Cargo mechanisms and ensuring the installed binary has the expected command name.
